#########################################################################
# File Name: insertsorter_unittest.py
# Purpose:
...
class InsertSorter_UnitTest(unittest.TestCase):
...
def fullSuite():
    ...
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(InsertSorter_UnitTest))
    return suite

def partSuite():
    suite=unittest.TestSuite()
    suite.addTest(InsertSorter_UnitTest("test_sortNorm"))
    return suite
